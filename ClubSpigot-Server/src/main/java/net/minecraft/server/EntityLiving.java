...
//                    flag = false;
    ...
    public void a(Entity entity, float f, double d0, double d1) {
        if (this.random.nextDouble() >= this.getAttributeInstance(GenericAttributes.c).getValue()) {
            ...
            this.motZ /= 2.0D;
            */
            double knockbackReductionHorizontal = 1.0D - ClubSpigot.INSTANCE.getConfig().getKnockbackHorizontal();
            double knockbackReductionVertical = 1.0D - ClubSpigot.INSTANCE.getConfig().getKnockbackVertical();
