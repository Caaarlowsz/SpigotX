            ...
            if (!entity.l(this)) {
                ...
                if (f > 0.0F || f1 > 0.0F) {
                    ...
                    if (flag2) {
                        ...
                        /*
                        entity.motX *= ClubSpigot.INSTANCE.getConfig().getKnockbackHorizontal();
                        entity.motY *= ClubSpigot.INSTANCE.getConfig().getKnockbackVertical();
                        entity.motZ *= ClubSpigot.INSTANCE.getConfig().getKnockbackHorizontal(); */
